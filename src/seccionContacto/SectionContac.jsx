...
const SectionContac = () => {
  return (
    <section id='contact-section'>
      <Row style={{ backgroundColor: 'blue', display: 'flex' }}>
        <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
          <Row>
            <Col xs={8} sm={8} md={8} lg={8} xl={8} xxl={8} style={{ display: 'flex', backgroundColor: 'red', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Col xs={8} sm={8} md={8} lg={8} xl={8} xxl={8} style={{ display: 'flex', backgroundColor: 'brown', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Col xs={8} sm={8} md={8} lg={8} xl={8} xxl={8} style={{ display: 'flex', backgroundColor: 'black', alignItems: 'center', justifyContent: 'center' }}>
