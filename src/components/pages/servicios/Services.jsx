    ...
    <>
      ...
      <Row id='Row__Hover' style={{ justifyContent: 'center', textAlign: 'center', marginTop: '30px' }}>
        ...
        <Row style={{ justifyContent: 'center', textAlign: 'center' }}>
          <Col xs={8} sm={8} md={8} lg={8} xl={8} xxl={8}>
            <p className='paragraph'>Con años de experiencia en la industria, hemos perfeccionado nuestra artesanía y técnicas para ofrecerte resultados excepcionales.</p>
          </Col>
          <Col xs={8} sm={8} md={8} lg={8} xl={8} xxl={8}>
            <p className='paragraph'>Con años de experiencia en la industria, hemos perfeccionado nuestra artesanía y técnicas para ofrecerte resultados excepcionales.</p>
          </Col>
