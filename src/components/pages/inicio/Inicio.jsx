...
const Inicio = () => {
  return (
    ...
    <div>
      <Row>
        <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24} style={{ alignItems: 'center', justifyContent: 'center', textAlign: 'center', display: 'flex' }}>
          <AwesomeSlider className='corrusel-react' style={{ }}>
            <div data-src={c1} />
            <div data-src={c2} />
            <div data-src={c3} />
          </AwesomeSlider>
      ...
      <Row id='Row-center' style={{ alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
        <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12} style={{ height: '100%', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
          <h1 className='Seccion-titulos' style={{ fontSize: '30px', margin: '0', height: '100%', width: '100%' }}>¡Bienvenido a nuestro sitio web especializado
        ...
        <Row>
          <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12} style={{ alignItems: 'center', justifyContent: 'center', position: 'relative', left: '25%', textAlign: 'center' }}>
            <p id='p-1' style={{ marginTop: '7%', fontSize: '20px' }}>
      ...
      <Row id='section-2' style={{ justifyContent: 'center', display: 'flex', flexWrap: 'wrap', alignContent: 'center', color: 'white' }}>
        <Col xs={6} sm={6} md={6} lg={6} xl={6} xxl={6}>
          ...
          <p>Nuestra experiencia en la industria nos permite ofrecerte una amplia gama de servicios, desde el diseño personalizado de canceles y vidrios hasta su fabricación e instalación
        ...
        <Col xs={6} sm={6} md={6} lg={6} xl={6} xxl={6}>
          <h3>¿Tienes alguna idea en mente o necesitas asesoramiento para dar vida a tu proyecto?</h3>
          <p>Contáctanos y uno de nuestros expertos estará encantado de asesorarte y ofrecerte un presupuesto sin compromiso.</p>
        </Col>
      </Row>
      <Row>
        <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12} style={{ justifyContent: 'center', alignItems: 'center', textAlign: 'center', marginTop: '/0px' }}>
          <h2>
            ¡Confía en Hergo!
          </h2>
          <p className='p-confianza' style={{ width: '100%', height: '100' }}>Para convertir tus sueños en realidad y crear ambientes que te enamoren! Estamos
        ...
        <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12} style={{ marginTop: '5%', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
