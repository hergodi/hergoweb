    ...
    <>
      ...
      <section id='contact-section'>
        <div className='contact'>
          ...
          <Col className='Display-toLineUp'>
            <svg xmlns='http://www.w3.org/2000/svg' width='50' height='50' fill='currentColor' className='bi bi-calendar3' viewBox='0 0 16 16'>
          ...
          <div className='horario'>
            <p>Horarios de tal hora a - tal hora</p>
          </div>
        </div>
      </section>
    </>
