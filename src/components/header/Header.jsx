...
export default function Header () {
  ...
  return (
    <Header className='header'>
                ...
                <Row>
                  <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                    <a href='https://wa.me/525576205492' target='__blank'>
                      <svg xmlns='http://www.w3.org/2000/svg' width='25' height='25' fill='currentColor' className='bi bi-whatsapp' viewBox='0 0 16 16' id='logos-header' style={{ color: 'rgba(62, 177, 58, 0.818)' }}>
                  ...
                  <Col xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                    <a href='https://www.facebook.com/profile.php?id=100093564843414' target='__blank'>
                      <svg xmlns='http://www.w3.org/2000/svg' width='25' height='25' fill='currentColor' className='bi bi-facebook' viewBox='0 0 16 16' id='logos-header-2' style={{ color: 'rgba(52, 52, 108, 0.818)' }}>
      ...
      <Row>
        <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
          <img src={lineaMenu} className='linea-menu' />
        </Col>
      </Row>
    </Header>
  )
